/*	Paul MacKay - V00967869 - SENG265 - Assignment 1
 *	The strategy I used to complete this assignment was:
 *
 *	- To create, two typedef structs, one containing the "Event" 
 *	example - 10:00 AM to 11:00 AM: ... etc
 *	the other containing "Day" example October 23, 2022 (Sunday)
 *	The reason I chose this is to be able to compare the struct fields in order to
 *	print the correct event on a given day (in many cases multiple events on a single day)
 *	The way that I compare Events and Days is I have both a Event and a Day
 *	array. I then use some sorting algorithms to sort the days and events in
 *	ascending order. I remove duplicate days. Then I compare the Day struct
 *	fields to the Event struct fields to know which Events happen on what day.
 *	More explination is provided later in the code, thank you.
 * 	
 * */
...
int main(int argc, char *argv[]) {
    ...
    for(int i = 0; i < alldays; i++){
                /*
                 * Get the appropriate range of dates, specified at stdin
